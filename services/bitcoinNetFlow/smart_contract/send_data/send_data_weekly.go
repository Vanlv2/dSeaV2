...
func CallContractMethodWeekly(config structData.ConfigContract, methodName string, params map[string]interface{}) error {
	...
	methodArgs, err := Time.PrepareMethodArgsWeekly(methodName, params)
	if err != nil {
		return err
	}
