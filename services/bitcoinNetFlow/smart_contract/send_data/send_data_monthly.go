...
func CallContractMethodMonthly(config structData.ConfigContract, methodName string, params map[string]interface{}) error {
	...
	methodArgs, err := Time.PrepareMethodArgsMonthly(methodName, params)
	if err != nil {
		return err
	}
